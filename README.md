...
3.  **Temporal Windowing**: Converting flat patient history into sequential windows for time-series modelling.
...
5.  **Interpretability Analysis**: Extracting attention weights to visualise model decision-making.
6.  **Clinical Optimisation**: Using Bayesian Optimisation for dose-finding recommendations.
